...
async function calculateProfitLoss() {
    ...
    try {
        ...
        // Проверка ввода
        if (isNaN(openPrice) || isNaN(closePrice) || isNaN(amount) || !pair) {
...
async function calculateDividend() {
    const assetSymbol = document.getElementById("div-asset").value;
    ...
    // Проверка ввода
    if (!assetSymbol || isNaN(priceOf1Share) || isNaN(numberOfShares) || isNaN(divPer1Share) || isNaN(ownPeriod)) {
        showAlert('error', 'Error', 'Please fill in all required fields with valid values!');
        return;
    }
            ...
            resultContent.innerHTML = `
                <div class="div-result">
                    ...
                    <div class="result-section">
                        ...
                        <div class="result-group">
                            <p class="result-label">Asset Symbol:</p>
                            <p class="result-value">${assetSymbol}</p>
                        </div>
                    ...
                    <div class="result-section">
                        ...
                        <div class="result-group">
                            ...
                            <p class="result-value">${(result.total_div_yield / ownPeriod).toFixed(2)}%</p>
                        </div>
                    </div>
                    ...
                    <div class="result-section">
                        ...
                        <div class="summary-item">
                            <p>Initial Investment: <strong>${(priceOf1Share * numberOfShares).toFixed(2)} ${fromCurrency}</strong></p>
