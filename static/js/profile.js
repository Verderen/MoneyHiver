document.addEventListener('DOMContentLoaded', function() {
    ...
    // Глобальные переменные для хранения данных об удалении
    ...
    window.deleteCalculation = function(calculationId, type) {
        ...
        // Находим элемент для получения названия
        ...
        // Устанавливаем название в модальное окно
    ...
    // Добавляем обработчик закрытия модального окна подтверждения удаления
